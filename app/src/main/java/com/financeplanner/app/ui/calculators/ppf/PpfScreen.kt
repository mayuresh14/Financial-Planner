        ...
        Column(
            ...
            state.error?.let { error ->
                val message = when (error) {
                    is PpfValidationError.InvalidInput -> stringResource(R.string.sip_error_invalid_input)
                    is PpfValidationError.InvalidValue -> error.rawMessage ?: stringResource(R.string.sip_error_invalid_input)
                }
            ...
            AnimatedVisibility(
                ...
                state.result?.let { PpfResultCard(it) }
            }
        }
    }
...
@Composable
private fun PpfResultCard(result: PpfResult) {
