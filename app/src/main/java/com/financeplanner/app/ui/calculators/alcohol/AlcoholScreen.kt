...
fun AlcoholScreen(
    onBack: () -> Unit,
    viewModel: AlcoholViewModel = hiltViewModel(),
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.calc_alcohol)) },
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.alcohol_screen_description),
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedTextField(
                    value = state.drinksPerWeek, onValueChange = viewModel::onDrinksPerWeekChange,
                    label = { Text(stringResource(R.string.alcohol_label_drinks_per_week)) },
                    modifier = Modifier.weight(1f), singleLine = true
                )
                AmountOutlinedTextField(
                    value = state.costPerDrink, onValueChange = viewModel::onCostPerDrinkChange,
                    label = { Text(stringResource(R.string.alcohol_label_cost_per_drink)) },
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.alcohol_label_years)) },
...
@Composable
private fun AlcoholResultCard(result: AlcoholResult, state: AlcoholUiState) {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
        val narrative = buildString {
            append(
                stringResource(
                    R.string.alcohol_result_narrative,
                    state.drinksPerWeek,
                    formatAmountWithWords(state.costPerDrink.toDoubleOrNull() ?: 0.0, currencyFormat),
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text(text = stringResource(R.string.alcohol_result_total_spent), style = MaterialTheme.typography.labelLarge)
                Text(
