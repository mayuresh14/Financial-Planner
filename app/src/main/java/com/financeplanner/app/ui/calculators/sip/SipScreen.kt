 ...
 * a scrollable form of OutlinedTextFields, a Calculate button, an animated
 * result card, and a settings icon opening the shared ThemeLanguageSheet.
    ...
    Scaffold(
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                state.result?.let { SipResultCard(it) }
            }
        }
    }
...
@Composable
private fun SipResultCard(result: SipResult) {
